...
<div class="app-content-container">
    <div class="card-custom">
        ...
        <div class="card-body-custom">
            <form action="{{ route('barang-keluar.store') }}" method="POST">
                ...
                <div class="form-row">
                    ...
                    <div class="form-col">
                        <div class="form-group">
                            ...
                            <input type="text" id="tanggal_keluar" name="tanggal_keluar" class="form-control-custom" placeholder="dd/mm/yyyy" onfocus="(this.type='date')" onblur="(this.type='text')">
                        </div>
                    </div>
                    <div class="form-col">
                        <div class="form-group">
                ...
                <div class="form-row">
                    {{-- Baris 2: Jumlah, Kategori, Satuan --}}
                    <div class="form-col">
                        <div class="form-group">
    ...
    <div class="card-custom">
        <div class="card-body-custom">
            ...
            <form action="{{ route('barangmasuk') }}" method="GET" class="d-flex gap-2">
                <input type="text" name="search" placeholder="Cari kode atau nama barang"
                    class="form-control" value="{{ request('search') }}">
                <button type="submit" class="btn btn-primary">Search</button>
                <a href="{{ route('barang-masuk.export') }}" class="btn btn-success">Export</a>
            </form>
            ...
            <div class="table-responsive-custom">
                <table class="table-custom" id="itemTable">
                    ...
                    <tbody>
                        ...
                        @empty
                        <tr>
                            <td colspan="6" style="text-align: center;">Belum ada data barang keluar.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
