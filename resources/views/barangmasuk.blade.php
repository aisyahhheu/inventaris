                ...
                <div class="form-row">
                    ...
                    <div class="form-col">
                        <div class="form-group">
                            ...
                            <input type="text" id="tanggal_masuk" name="tanggal_masuk" class="form-control-custom" placeholder="dd/mm/yyyy" onfocus="(this.type='date')" onblur="(this.type='text')">
                        </div>
                    </div>
                    <div class="form-col">
                        <div class="form-group">
            ...
            <div class="table-responsive-custom">
                <table class="table-custom" id="itemTable">
                    ...
                    <tbody>
                        ...
                        @empty
                        <tr>
                            <td colspan="6" style="text-align: center;">Belum ada data barang masuk.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
